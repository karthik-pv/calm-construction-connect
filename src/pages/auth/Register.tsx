            ...
            <div className="flex flex-col items-center text-center h-full gap-4">
              ...
              <div>
                ...
                <div className="mt-3 text-left">
                  <p className="text-sm font-medium mb-1">As a patient, you can:</p>
                  <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
                    {expertServices.patient.map((service, index) => (
                      <li key={index}>{service}</li>
                    ))}
                  </ul>
                </div>
              </div>
              <Link to="/register/patient" className="mt-auto w-full">
            ...
            <div className="flex flex-col items-center text-center h-full gap-4">
              ...
              <div>
                ...
                <div className="mt-3 text-left">
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
                    {expertServices.therapist.map((service, index) => (
                      <li key={index}>{service}</li>
                    ))}
                  </ul>
                </div>
              </div>
              <Link to="/register/therapist" className="mt-auto w-full">
                <Button className="w-full">Register as Therapist</Button>
              </Link>
            </div>
          </div>
        </motion.div>
            ...
            <div className="flex flex-col items-center text-center h-full gap-4">
              ...
              <div>
                ...
                <div className="mt-3 text-left">
                  <p className="text-sm font-medium mb-1">Services provided:</p>
                  <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
                    {expertServices.relationship_expert.map((service, index) => (
                      <li key={index}>{service}</li>
                    ))}
                  </ul>
                </div>
              </div>
              <Link to="/register/relationship_expert" className="mt-auto w-full">
                <Button className="w-full">Register as Relationship Expert</Button>
              </Link>
            </div>
          </div>
        </motion.div>
            ...
            <div className="flex flex-col items-center text-center h-full gap-4">
              ...
              <div>
                ...
                <div className="mt-3 text-left">
                  <p className="text-sm font-medium mb-1">Services provided:</p>
                  <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
                    {expertServices.financial_expert.map((service, index) => (
                      <li key={index}>{service}</li>
                    ))}
                  </ul>
                </div>
              </div>
              <Link to="/register/financial_expert" className="mt-auto w-full">
                <Button className="w-full">Register as Financial Expert</Button>
              </Link>
            </div>
          </div>
        </motion.div>
            ...
            <div className="flex flex-col items-center text-center h-full gap-4">
              ...
              <div>
                ...
                <div className="mt-3 text-left">
                  <p className="text-sm font-medium mb-1">Services provided:</p>
                  <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
                    {expertServices.dating_coach.map((service, index) => (
                      <li key={index}>{service}</li>
                    ))}
                  </ul>
                </div>
              </div>
              <Link to="/register/dating_coach" className="mt-auto w-full">
                <Button className="w-full">Register as Dating Coach</Button>
              </Link>
            </div>
          </div>
        </motion.div>
            ...
            <div className="flex flex-col items-center text-center h-full gap-4">
              ...
              <div>
                ...
                <div className="mt-3 text-left">
                  <p className="text-sm font-medium mb-1">Services provided:</p>
                  <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
                    {expertServices.health_wellness_coach.map((service, index) => (
                      <li key={index}>{service}</li>
                    ))}
                  </ul>
                </div>
              </div>
              <Link to="/register/health_wellness_coach" className="mt-auto w-full">
                <Button className="w-full">Register as Health & Wellness Coach</Button>
              </Link>
            </div>
          </div>
        </motion.div>
