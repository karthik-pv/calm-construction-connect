...
import { Send, User, Clock, MoreVertical, Phone, Video, Image, ArrowLeft, Loader2 } from "lucide-react";
...
import { useChatMessages, useChatConversations, useAvailableTherapists, useSendChatMessage, useMarkMessagesAsRead, formatMessageTime } from "@/hooks/useChat";
...
export default function PatientChat() {
  ...
  }, [id, messages, markMessagesAsRead]);
                        ...
                        >
                          <div 
                            className={`flex items-center gap-3 p-3 rounded-lg hover:bg-secondary/50 transition-colors ${
                              currentPartner?.id === conv.id ? 'bg-secondary/30' : ''
                            }`}
                          >
              ...
              <ScrollArea className="flex-1 p-4">
                {messagesLoading ? (
                  ...
                  <div className="flex flex-col justify-center items-center h-full text-center p-4">
                    ...
                    <h3 className="text-xl font-bold mb-2">{currentPartner.name}</h3>
                    <p className="text-muted-foreground mb-6 max-w-md">
                      This is the beginning of your conversation with {currentPartner.name}.
