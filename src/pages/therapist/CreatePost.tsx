...
export default function CreatePost() {
  ...
  return (
    <DashboardLayout>
      <div className="p-6">
        <PageTitle title="Create Post" subtitle="Share valuable mental health insights with construction workers" />
          ...
          <Card className="bg-black/40 border-border backdrop-blur-md">
            <form onSubmit={handleSubmit}>
              <CardHeader>
                ...
                <CardDescription>
                  Create a post to share mental health advice, resources, or insights
                </CardDescription>
              </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <span>Upload Image{selectedImages.length > 0 ? `s (${selectedImages.length})` : ""}</span>
                    </label>
                    <input 
                      id="images" 
                      type="file" 
                  ...
                  {videoUrl && (
                    <div className="mt-2 rounded-md overflow-hidden">
                      <div className="aspect-video rounded-lg overflow-hidden bg-black/20 flex items-center justify-center">
                        ...
                        <p className="text-sm text-muted-foreground ml-2">Video preview will appear in the published post</p>
                      </div>
                    </div>
                  )}
                </div>
